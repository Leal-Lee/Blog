...
export default {
  ...
  methods: {
    ...
    async fetchData(query) {
      ...
      this.comment = await getComments(query);
     

      if(typeof this.comment =='string') return this.tableData=[]

      this.tableData = this.comment.rows;
      if(this.comment.count <=query.limit){
        this.isSingle=true
      }
    },
